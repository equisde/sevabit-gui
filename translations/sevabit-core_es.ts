...
<context>
    ...
    <message>
        ...
        <translation>Para poder ofuscar qué entradas han sido gastadas en las transacciones de SevaBit, un tercero no debería poder determinar de las firmas circulares cuales han sido gastadas en esas entradas. Hacerlo debilitaría la protección que proporcionan las firmas. Si solo una de las entradas pudiera ser determinada en el gasto, entonces esa entrada se vuelve evidente, anulando el efecto de las firmas. Las firmas circulares son una de las capas principales que usa SevaBit para proteger la privacidad.&lt;br&gt;Para evitar que las transacciones usen estas entradas, puede ser usada una lista de entradas gastadas para evitar usarlas en nuevas transacciones. Esa lista es mantenida por el proyecto SevaBit y está disponible en la página web getloki.org y la puedes importar desde aquí.&lt;br&gt;De lo contrario, puede escanear la cadena de bloques (y las cadenas de bloques de los clones de SevaBit que reusan las claves) usted mismo usando la herramienta de SevaBit de salidas excluidas para crear una lista conocida de las salidas gastadas.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Para evitar anular la protección proporcionada por las firmas círculares de SevaBit, una salida no deberia ser gastada en otras cadenas de bloques con diferentes firmas. Esto normalmente no es una preocupacion, pero puede convertirse en una si un clon de SevaBit que reusa las claves te permite gastar salidas existentes. En este caso, deberás asegurar que las salidas existentes usen las mismas firmas en ambas cadenas.&lt;br&gt;Esto lo hará SevaBit y cualquier software para reusar claves de manera automática que no este tratando de estropear directamente tu privacidad.&lt;br&gt;Si estás usando un clon de SevaBit de claves reusadas y éste clon no incluye esta protección, puedes asegurar que tus transacciones esten protegidas si gastas primero a través del clon, despues agregas manualmente las firmas a esta página, que luego te permite gastar tus SevaBit con seguridad.&lt;br&gt;Si no utilizas un clon de SevaBit que reusa claves sin estas herramientas de seguridad, entonces no debes hacer nada ya que se hace de manera automatizada.&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">La minería asegura la red de SevaBit y además paga una pequeña recompensa por el trabajo realizado. Esta opción permite que SevaBit mine mientras su computadora está ociosa. El minado se detendrá cuando continúe trabajando con ella.</translation>
    </message>
</context>
<context>
