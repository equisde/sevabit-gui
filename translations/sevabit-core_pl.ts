...
<context>
    ...
    <message>
        ...
        <translation>W celu ukrycia, które wejścia w transakcji SevaBit są wydawane, osoba postronna nie powinna być w stanie stwierdzić, które wejścia w pierścieniu już zostały wydane. Gdyby była w stanie to zrobić, osłabiłoby to ochronę zapewnioną przez podpisy pierścieniowe. Jeśli wiadomo, że wszystkie wejścia poza jednym zostały wydane, to staje się oczywiste, które wejście faktycznie jest wydawane, a to niweczy efekt podpisów pierścieniowych - jednych z trzech głównych warstw ochrony prywatności używanych przez SevaBit.&lt;br&gt;Aby pomóc transakcjom unikać tych wejść, lista już wydanych wejść może być użyta do pominięcia ich w nowych transakcjach. Takowa lista jest zarządzana przez projekt SevaBit i jest dostępna na stronie getloki.org, skąd można ją tutaj pobrać.&lt;br&gt;Ewentualnie, możesz przeskanować blockchain (oraz blockchain klona SevaBit, który wykorzystuje ponownie klucze) samemu używając narzędzia sevabit-blockchain-blackball do utworzenia listy wydanych wyjść.&lt;br&gt;</translation>
    </message>
    <message>
