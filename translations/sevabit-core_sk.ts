...
<message>
    ...
    <message>
        ...
        <translation>Táto stránka Vám umožní komunikovať so zdieľanou databázou okruhov. Táto databáza je určená na použitie s SevaBit peňazenkami a taktiež s peňaženkami SevaBit klonov, ktoré opätovne používajú SevaBit kľúče.</translation>
    </message>
    <message>
...
<message>
    ...
    <message>
        ...
        <translation>Aby bolo možné skryť, ktoré vstupy v SevaBit transakcii sa vynakladajú, tretia strana by nemala vedieť, ktoré vstupy v okruhu sú už známe. Možnosť tak urobiť by oslabila ochranu poskytovanú okruhovými podpismi. Ak je už známe, že všetky vstupy sú už vynaložené, tak aktuálne vynakladaný vstup sa jasne identifikuje, čím sa zruší účinok okuhových podpisov, čo je jedna z troch hlavných vrstiev ochrany súkromia, ktoré SevaBit používa.&lt;br&gt;Pomôcť transakciám vyhnúť sa týmto vstupom môžete použiť zoznam známych vstupov, aby ste sa vyhli ich použitiu v nových transakciách. Takýto zoznam si udržiava projekt SevaBit a je k dispozícii na webovej stránke getloki.org a tu môžete tento zoznam importovať.&lt;br&gt;Alternatívne môžete prehliadať blockchain (a blockchain SevaBit klonov, ktoré tiež používajú SevaBit kľúče) sami pomocou nástroja sevabit-blockchain-blackball a vytvoriť zoznam známych vynaložených výstupov. &lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Aby sa zabránilo zrušeniu ochrany, ktorú poskytujú SevaBit okruhové podpisy, výstup by nemal byť vynaložený s rôznymi okruhmi na rôznych blockchain-och. Zatiaľ čo to zvyčajne nie je problém, môže sa ním stať, keď SevaBit klon používajúci SevaBit kľúče umožní vynaložiť existujúce výstupy. V tomto prípade musíte zabezpečiť, aby existujúce výstupy používali rovnaký okruh na oboch blockchain-ohc.&lt;br&gt;Toto sa bude robiť automaticky SevaBit softvérom a akýmkoľvek softvérom používajúcim SevaBit kľúče, ktorý sa nepokúša aktívne redukovať Vaše súkromie.&lt;br&gt;Ak používate aj SevaBit klon, používajúci SevaBit kľúče, a tento klon túto ochranu neobsahuje, stále môžete zabezpečiť bezpečnosť Vašich transakcií vynaložením najskôr na klone, a následne ručne pridali okruh na tejto stránke, čo Vám potom umožní vynaložiť Vaše SevaBit bezpečne.&lt;br&gt;Ak nepoužívate SevaBit klon bez týchto bezpečnostných funkcií, nemusíte nič robiť, pretože je všetko automatizované.&lt;br&gt;</translation>
    </message>
    <message>
