...
<context>
    ...
    <message>
        ...
        <translation>För att dölja vilja ingångar som spenderas i en viss SevaBit-transaktion får en tredje part inte kunna avgöra vilka ingångar i en ring som med säkerhet redan har spenderats. Om det var möjligt skulle skyddet som ges av ringsignaturer försvagas. Om alla utom en av ingångarna med säkerhet redan har spenderats så blir det uppenbart vilken ingång som faktiskt spenderas. Då upphävs effekten av ringsignaturer, vilket är ett av de tre huvudsakliga lager av sekretesskydd som SevaBit använder.&lt;br&gt;För att hjälpa transaktioner att undvika dessa ingångar kan en lista över med säkerhet spenderade utgångar användas för att undvika att dessa används i nya transaktioner. SevaBit-projektet upprätthåller en sådan lista och den finns tillgänglig på webbplatsen getloki.org. Du kan importera listan här.&lt;br&gt;Alternativt kan du själv skanna blockkedjan (och blockkedjan för SevaBit-kloner som återanvänder nycklar) genom att använda verktyget sevabit-blockchain-blackball för att skapa en lista över med säkerhet spenderade utgångar.&lt;br&gt;</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>Mining secures the SevaBit network, and also pays a small reward for the work done. This option will let SevaBit mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation type="vanished">Brytningen säkrar Lokis nätverk, och betalar även en liten ersättning för det arbete som utförs. Detta alternativ låter SevaBit bryta när din dator är nätansluten men inaktiv. Brytningen stoppas när du fortsätter att arbeta igen.</translation>
    </message>
</context>
<context>
